 ...
 * {@link com.resume.service.impl.DetailsLocalServiceImpl} and is the
...
public class DetailsLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.resume.service.impl.DetailsLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.resume.model.Details addDetails(
	...
	*/
	public static com.resume.model.Details createDetails(long detailsId) {
		return getService().createDetails(detailsId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.resume.model.Details deleteDetails(long detailsId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteDetails(detailsId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.resume.model.Details deleteDetails(
		com.resume.model.Details details)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static com.resume.model.Details fetchDetails(long detailsId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchDetails(detailsId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.resume.model.Details getDetails(long detailsId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getDetails(detailsId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.resume.model.Details> getDetailses(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.resume.model.Details updateDetails(
		com.resume.model.Details details)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static com.resume.model.Details addDetails(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addDetails(newDetail, resumeId);
	}

	public static java.util.List<com.resume.model.Details> getDetailsOfResume(
		long resumeId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getDetailsOfResume(resumeId);
	}
	...
	public static DetailsLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					DetailsLocalService.class.getName());

			if (invokableLocalService instanceof DetailsLocalService) {
				_service = (DetailsLocalService)invokableLocalService;
			}
			else {
				_service = new DetailsLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(DetailsLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(DetailsLocalService service) {
	}

	private static DetailsLocalService _service;
}